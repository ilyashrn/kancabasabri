                                ...
                                <div class="card-body px-1">
                                    <div id="recent-buyers" class="list-group height-300 position-relative">
                                        <a href="#" class="list-group-item list-group-item-action media no-border">
                                            <div class="media-left">
                                                <span class="avatar avatar-md avatar-online">
                                                    <img class="media-object rounded-circle" src="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/app-assets/images/portrait/small/avatar-s-7.png"
                                            ...
                                            <div class="media-body">
                                                <h6 class="list-group-item-heading">Kristopher Candy
                                                    <span class="font-medium-4 float-xs-right pt-1">$1,021</span>
                                                </h6>
                                                <p class="list-group-item-text">
                                                    <span class="tag tag-primary">Electronics</span>
                                                    <span class="tag tag-warning ml-1">Decor</span>
                                                </p>
                                            </div>
                                        </a>
                                        <a href="#" class="list-group-item list-group-item-action media no-border">
                                            <div class="media-left">
                                                <span class="avatar avatar-md avatar-away">
                                                    <img class="media-object rounded-circle" src="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/app-assets/images/portrait/small/avatar-s-8.png"
                                                         alt="Generic placeholder image">
                                                    <i></i>
                                                </span>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="list-group-item-heading">Lawrence Fowler
                                                    <span class="font-medium-4 float-xs-right pt-1">$2,021</span>
                                                </h6>
                                                <p class="list-group-item-text">
                                                    <span class="tag tag-danger">Appliances</span>
                                                </p>
                                            </div>
                                        </a>
                                        <a href="#" class="list-group-item list-group-item-action media no-border">
                                            <div class="media-left">
                                                <span class="avatar avatar-md avatar-busy">
                                                    <img class="media-object rounded-circle" src="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/app-assets/images/portrait/small/avatar-s-9.png"
                                                         alt="Generic placeholder image">
                                                    <i></i>
                                                </span>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="list-group-item-heading">Linda Olson
                                                    <span class="font-medium-4 float-xs-right pt-1">$1,112</span>
                                                </h6>
                                                <p class="list-group-item-text">
                                                    <span class="tag tag-primary">Electronics</span>
                                                    <span class="tag tag-success ml-1">Office</span>
                                                </p>
                                            </div>
                                        </a>
                                        <a href="#" class="list-group-item list-group-item-action media no-border">
                                            <div class="media-left">
                                                <span class="avatar avatar-md avatar-online">
                                                    <img class="media-object rounded-circle" src="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/app-assets/images/portrait/small/avatar-s-10.png"
                                                         alt="Generic placeholder image">
                                                    <i></i>
                                                </span>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="list-group-item-heading">Roy Clark
                                                    <span class="font-medium-4 float-xs-right pt-1">$2,815</span>
                                                </h6>
                                                <p class="list-group-item-text">
                                                    <span class="tag tag-warning">Decor</span>
                                                    <span class="tag tag-danger ml-1">Appliances</span>
                                                </p>
                                            </div>
                                        </a>
                                        <a href="#" class="list-group-item list-group-item-action media no-border">
                                            <div class="media-left">
                                                <span class="avatar avatar-md avatar-online">
                                                    <img class="media-object rounded-circle" src="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/app-assets/images/portrait/small/avatar-s-11.png"
                                                         alt="Generic placeholder image">
                                                    <i></i>
                                                </span>
                                            </div>
                                        ...
                                        <a href="#" class="list-group-item list-group-item-action media no-border">
                                            <div class="media-left">
                                                <span class="avatar avatar-md avatar-away">
                                                    <img class="media-object rounded-circle" src="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/app-assets/images/portrait/small/avatar-s-12.png"
                                                         alt="Generic placeholder image">
                                                    <i></i>
                                                </span>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="list-group-item-heading">Lawrence Fowler
                                                    <span class="font-medium-4 float-xs-right pt-1">$1,321</span>
                                                </h6>
                                                <p class="list-group-item-text">
                                                    <span class="tag tag-danger">Appliances</span>
                                                </p>
                                ...
                                <div class="card-body">
                                    <div class="card-block">
                                        <p>Total paid invoices 240, unpaid 150.
                                            <span class="float-xs-right"><a href="project-summary.html" target="_blank">Invoice Summary <i class="ft-arrow-right"></i></a></span>
                                        </p>
                                    </div>
                                    ...
                                    <div class="card-footer bg-gradient-x-danger no-border">
                                        <div class="row">
                                            <div class="col-xs-4 text-xs-center display-table-cell white">
                                                <i class="me-wind font-large-1 lighten-3 valign-middle"></i>
                                                <span class="valign-middle">2MPH</span>
                                            </div>
                                            <div class="col-xs-4 text-xs-center display-table-cell white">
                                                <i class="me-sun2 font-large-1 lighten-3 valign-middle"></i>
                                                <span class="valign-middle">2%</span>
                                            </div>
                                            <div class="col-xs-4 text-xs-center display-table-cell white">
                                                <i class="me-thermometer font-large-1 lighten-3 valign-middle"></i>
                                                <span class="valign-middle">13.0&deg;</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row match-height">
                                                ...
                                                <div class="events-content">
                                                    <ol>
                                                        <li class="selected" data-date="16/01/2015">
                                                            <blockquote class="blockquote no-border">
                                                                <div class="media">
                                                                    <div class="media-left">
                                                                        <img class="media-object img-xl" src="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/app-assets/images/portrait/small/avatar-s-5.png"
                                                                             alt="Generic placeholder image">
                                                                    </div>
                                                                    <div class="media-body">
                                                                ...
                                                                <footer class="blockquote-footer text-xs-right">Steve Jobs
                                                        ...
                                                        <li data-date="28/02/2015">
                                                            <blockquote class="blockquote no-border">
                                                                <div class="media">
                                                                    <div class="media-left">
                                                                        <img class="media-object img-xl" src="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/app-assets/images/portrait/small/avatar-s-6.png"
                                                                             alt="Generic placeholder image">
                                                                    </div>
                                                                    <div class="media-body">
                                                                        Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                        ...
                                                        <li data-date="20/04/2015">
                                                            <blockquote class="blockquote no-border">
                                                                <div class="media">
                                                                    <div class="media-left">
                                                                        <img class="media-object img-xl" src="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/app-assets/images/portrait/small/avatar-s-7.png"
                                                                             alt="Generic placeholder image">
                                                                    </div>
                                                                    <div class="media-body">
                                                                        Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                        ...
                                                        <li data-date="20/05/2015">
                                                            <blockquote class="blockquote no-border">
                                                                <div class="media">
                                                                    <div class="media-left">
                                                                        <img class="media-object img-xl" src="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/app-assets/images/portrait/small/avatar-s-8.png"
                                                                             alt="Generic placeholder image">
                                                                    </div>
                                                                    <div class="media-body">
                                                                        Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                        ...
                                                        <li data-date="09/07/2015">
                                                            <blockquote class="blockquote no-border">
                                                                <div class="media">
                                                                    <div class="media-left">
                                                                        <img class="media-object img-xl" src="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/app-assets/images/portrait/small/avatar-s-9.png"
                                                                             alt="Generic placeholder image">
                                                                    </div>
                                                                    <div class="media-body">
                                                                        Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                        ...
                        <div class="col-xl-4 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <img class="img-fluid" src="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/app-assets/images/carousel/06.jpg" alt="Card image cap">
                                    <div class="card-block">
